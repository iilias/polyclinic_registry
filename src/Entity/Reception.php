 ...
 * Reception
 *
 * @ORM\Table(name="reception", indexes={@ORM\Index(name="id_diagnosis", columns={"id_diagnosis"}), @ORM\Index(name="id_patient", columns={"id_patient"}), @ORM\Index(name="id_employee", columns={"id_employee"})})
