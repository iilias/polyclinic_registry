 ...
 * Results
 *
 * @ORM\Table(name="results", indexes={@ORM\Index(name="id_procedures", columns={"id_procedures"}), @ORM\Index(name="id_reception", columns={"id_reception"}), @ORM\Index(name="id_analyzes", columns={"id_analyzes"})})
